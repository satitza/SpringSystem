...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["Title"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _shared_interceptor_http404_interceptor__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./shared/interceptor/http404-interceptor */ "./src/app/shared/interceptor/http404-interceptor.ts");
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [{
                ...
                { provide: 'localStorage', useValue: window.localStorage },
                {
                    ...
                    useClass: _shared_interceptor_http404_interceptor__WEBPACK_IMPORTED_MODULE_19__["Http401Interceptor"],
                    multi: true
                },
            ],
...
/* harmony import */ var _shared_guard_authen_guard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/guard/authen.guard */ "./src/app/shared/guard/authen.guard.ts");
...
var routes = [
    ...
    },
    {
        ...
        ], canActivate: [_shared_guard_authen_guard__WEBPACK_IMPORTED_MODULE_8__["AuthenGuard"]]
    },
...
/* harmony import */ var _shared_service_authen_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/service/authen.service */ "./src/app/shared/service/authen.service.ts");
...
var DefaultLayoutComponent = /** @class */ (function () {
    function DefaultLayoutComponent(authenService) {
    ...
    DefaultLayoutComponent.prototype.ngOnInit = function () {
        var _this = this;
        // get current user
        this.authenService.getCurrentUser().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).subscribe(function (res) {
    ...
    DefaultLayoutComponent.prototype.logout = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authenService.logout()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    DefaultLayoutComponent.ctorParameters = function () { return [
        { type: _shared_service_authen_service__WEBPACK_IMPORTED_MODULE_3__["AuthenService"] }
    ]; };
    DefaultLayoutComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_shared_service_authen_service__WEBPACK_IMPORTED_MODULE_3__["AuthenService"]])
...
/***/ "./src/app/shared/guard/authen.guard.ts":
/*!**********************************************!*\
  !*** ./src/app/shared/guard/authen.guard.ts ***!
  \**********************************************/
/*! exports provided: AuthenGuard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthenGuard", function() { return AuthenGuard; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _service_authen_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/authen.service */ "./src/app/shared/service/authen.service.ts");





var AuthenGuard = /** @class */ (function () {
    function AuthenGuard(authenService, http, router) {
        this.authenService = authenService;
        this.http = http;
        this.router = router;
    }
    AuthenGuard.prototype.canActivate = function () {
    ...
    AuthenGuard.ctorParameters = function () { return [
        { type: _service_authen_service__WEBPACK_IMPORTED_MODULE_4__["AuthenService"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    AuthenGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({ providedIn: 'root' }),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_service_authen_service__WEBPACK_IMPORTED_MODULE_4__["AuthenService"],
...
/***/ "./src/app/shared/interceptor/http404-interceptor.ts":
/*!***********************************************************!*\
  !*** ./src/app/shared/interceptor/http404-interceptor.ts ***!
  \***********************************************************/
/*! exports provided: Http401Interceptor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Http401Interceptor", function() { return Http401Interceptor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var Http401Interceptor = /** @class */ (function () {
    function Http401Interceptor(router) {
        var _this = this;
        this.router = router;
        this.active = true;
    ...
    Http401Interceptor.prototype.intercept = function (req, next) {
        var _this = this;
        return next.handle(req).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (event) {
        }, function (err) {
            _this.hadleError(err);
        }));
    };
    Http401Interceptor.prototype.hadleError = function (err) {
    ...
    Http401Interceptor.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    Http401Interceptor = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], Http401Interceptor);
    return Http401Interceptor;
}());
...
/***/ "./src/app/shared/service/authen.service.ts":
/*!**************************************************!*\
  !*** ./src/app/shared/service/authen.service.ts ***!
  \**************************************************/
...
var AuthenService = /** @class */ (function () {
    function AuthenService(http, localStorage, router) {
        this.http = http;
        this.localStorage = localStorage;
        this.router = router;
        this.isLoggedIn = false;
        this.isLoggedInSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"](1);
    ...
    AuthenService.prototype.authentication = function (loginRequest) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var formData;
            var _this = this;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                ...
                this.http.post('authentication', formData).subscribe(function (res) {
                    if (res) {
                        _this.isLoggedInSubject.next(true);
                        _this.isLoggedIn = true;
                        _this.setLogin(_this.isLoggedIn);
                        if (_this.getAuthenticationStatus()) {
                            _this.getCurrentUserFormServer();
    ...
    AuthenService.prototype.getCurrentUserFormServer = function () {
        var _this = this;
        this.http.get('api/user/current').subscribe(function (res) {
            if (res) {
                _this.user.next(res);
            }
        });
    };
    AuthenService.prototype.getCurrentUser = function () {
        return this.user;
    };
    AuthenService.prototype.setLogin = function (loggedIn) {
        this.localStorage.setItem('logedIn', '' + loggedIn);
    };
    AuthenService.prototype.getAuthenticationStatus = function () {
    ...
    AuthenService.prototype.logout = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                // @ts-ignore
                this.http.post('logout').subscribe(function (res) {
                    _this.clearAuthen();
    ...
    AuthenService.prototype.clearAuthen = function () {
        this.isLoggedInSubject.next(false);
        this.isLoggedIn = false;
        this.clearStorage();
    };
    AuthenService.prototype.clearStorage = function () {
        this.localStorage.clear();
    };
    AuthenService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: Storage, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: ['localStorage',] }] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
    AuthenService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])('localStorage')),
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_service_authen_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/service/authen.service */ "./src/app/shared/service/authen.service.ts");



var LoginComponent = /** @class */ (function () {
    function LoginComponent(authenService) {
        this.authenService = authenService;
        this.loginRequest = {};
    }
    LoginComponent.prototype.login = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authenService.authentication(this.loginRequest)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    LoginComponent.ctorParameters = function () { return [
        { type: _shared_service_authen_service__WEBPACK_IMPORTED_MODULE_2__["AuthenService"] }
    ]; };
    LoginComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_shared_service_authen_service__WEBPACK_IMPORTED_MODULE_2__["AuthenService"]])
    ], LoginComponent);
...
module.exports = __webpack_require__(/*! /home/anonymous/Project/Java/SpringSystem/src/main/web/src/main.ts */"./src/main.ts");
